...
pub const Binding = extern struct {
    ...
    pub fn getFallbackValue(self: *@This()) core.HResult!*IInspectable {
        ...
        try IUnknown.QueryInterface(@ptrCast(self), &IBinding2.IID, @ptrCast(&this));
...
pub const CurrentChangingEventHandler = extern struct {
    ...
    pub fn init(
        cb: *const fn(?*anyopaque, sender: *IInspectable, e: *CurrentChangingEventArgs) void,
    ) !*@This() {
    ...
    pub fn Invoke(self: *anyopaque, sender: *IInspectable, e: *CurrentChangingEventArgs) callconv(.winapi) HRESULT {
        const this: *@This() = @ptrCast(@alignCast(self));
        const _callback: *const fn(?*anyopaque, sender: *IInspectable, e: *CurrentChangingEventArgs) void = @ptrCast(@alignCast(this._cb));
...
pub const PropertyChangedEventHandler = extern struct {
    ...
    /// references are released including any references Windows makes.
    pub fn init(
        cb: *const fn(?*anyopaque, sender: *IInspectable, e: *PropertyChangedEventArgs) void,
    ) !*@This() {
        const _r = try @import("std").heap.c_allocator.create(@This());
        _r.* = .{
            .vtable = &VTABLE,
    ...
    pub fn Invoke(self: *anyopaque, sender: *IInspectable, e: *PropertyChangedEventArgs) callconv(.winapi) HRESULT {
        const this: *@This() = @ptrCast(@alignCast(self));
        const _callback: *const fn(?*anyopaque, sender: *IInspectable, e: *PropertyChangedEventArgs) void = @ptrCast(@alignCast(this._cb));
        _callback(this._context, sender, e);
        return 0;
    }
