...
pub const PhoneCallOrigin = extern struct {
    ...
    pub fn getDisplayName(self: *@This()) core.HResult!?HSTRING {
        ...
        try IUnknown.QueryInterface(@ptrCast(self), &IPhoneCallOrigin2.IID, @ptrCast(&this));
    ...
    pub fn getDisplayPicture(self: *@This()) core.HResult!*StorageFile {
        ...
        defer _ = IUnknown.Release(@ptrCast(this));
        try IUnknown.QueryInterface(@ptrCast(self), &IPhoneCallOrigin3.IID, @ptrCast(&this));
