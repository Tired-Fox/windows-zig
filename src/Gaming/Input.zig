...
pub const ArcadeStick = extern struct {
    ...
    pub fn addHeadsetConnected(self: *@This(), value: *TypedEventHandler(IGameController,Headset)) core.HResult!EventRegistrationToken {
        ...
        try IUnknown.QueryInterface(@ptrCast(self), &IGameController.IID, @ptrCast(&this));
    ...
    pub fn TryGetBatteryReport(self: *@This()) core.HResult!*BatteryReport {
        ...
        defer _ = IUnknown.Release(@ptrCast(this));
        try IUnknown.QueryInterface(@ptrCast(self), &IGameControllerBatteryInfo.IID, @ptrCast(&this));
...
pub const ArcadeStickButtons = packed struct(u32) {
    StickUp: bool = false,
    StickDown: bool = false,
    StickLeft: bool = false,
    StickRight: bool = false,
    Action1: bool = false,
    Action2: bool = false,
    Action3: bool = false,
    Action4: bool = false,
...
pub const FlightStickButtons = packed struct(u32) {
    FirePrimary: bool = false,
    FireSecondary: bool = false,
    _m: u30 = 0,
};
...
pub const Gamepad = extern struct {
    ...
    pub fn GetButtonLabel(self: *@This(), button: GamepadButtons) core.HResult!GameControllerButtonLabel {
        ...
        defer _ = IUnknown.Release(@ptrCast(this));
        try IUnknown.QueryInterface(@ptrCast(self), &IGamepad2.IID, @ptrCast(&this));
        return try this.?.GetButtonLabel(button);
    }
    pub fn TryGetBatteryReport(self: *@This()) core.HResult!*BatteryReport {
        var this: ?*IGameControllerBatteryInfo = undefined;
...
pub const GamepadButtons = packed struct(u32) {
    ...
    LeftThumbstick: bool = false,
    RightThumbstick: bool = false,
    Paddle1: bool = false,
    Paddle2: bool = false,
    Paddle3: bool = false,
    Paddle4: bool = false,
...
pub const OptionalUINavigationButtons = packed struct(u32) {
    Context1: bool = false,
    Context2: bool = false,
    Context3: bool = false,
    Context4: bool = false,
    ...
    PageDown: bool = false,
    PageLeft: bool = false,
    PageRight: bool = false,
    ScrollUp: bool = false,
    ScrollDown: bool = false,
    ScrollLeft: bool = false,
    ScrollRight: bool = false,
    _m: u20 = 0,
};
...
pub const RacingWheelButtons = packed struct(u32) {
    PreviousGear: bool = false,
    NextGear: bool = false,
    DPadUp: bool = false,
    DPadDown: bool = false,
    DPadLeft: bool = false,
...
pub const RawGameController = extern struct {
    ...
    pub fn getSimpleHapticsControllers(self: *@This()) core.HResult!*IVectorView(SimpleHapticsController) {
        ...
        defer _ = IUnknown.Release(@ptrCast(this));
        try IUnknown.QueryInterface(@ptrCast(self), &IRawGameController2.IID, @ptrCast(&this));
...
pub const RequiredUINavigationButtons = packed struct(u32) {
    Menu: bool = false,
    View: bool = false,
    Accept: bool = false,
    Cancel: bool = false,
